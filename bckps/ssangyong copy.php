...
<section class="total fondo-azul-ssangyong">
    <section class="container top-20 bottom-20">
        <div class="row text-left">
            <div class="col-md-2">
                <img src="imgs/logo-ssangyong-landing.png" class="img-fluid" alt="">
            </div>
	        
            <div class="col-md-7">
                <h2 class="blanco titulo-ssangyong top-40">ACCESORIOS SSANGYONG</h2>
            </div>
        </div>
    </section>
</section>
                ...
                <form role="form" action="">
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-3 text-center">
                            <button class="btn btn-lg btn-ssangyong inline-block"><i class="fas fa-search mr-2"></i>Filtrar</button>
                            <button class="btn btn-lg btn-ssangyong inline-block"><i class="fas fa-search mr-2"></i>Eliminar Filtrar</button>
                        </div>
                ...
                <div class="col-md-12 top-20">
                    <div class="row text-left">
                        ...
                        <div class="col-md-3 bottom-30">
                            <img src="imgs/producto-ssangyong-1.png" class="img-fluid" alt="">
                            <p class="destacado no-space">Kit Barras Antivuelcos Ssangyong
                                <br>ACTYON
                                <br>SKU: 123456789
                            </p>
                            <h3><strong>$49.700</strong></h3>
                            <a href="ssangyong-interno.php" class="btn btn-lg btn-cotizar bloque">COTIZAR</a>
                        </div> <!-- col-3 -->

                        <div class="col-md-3 bottom-30">
                            <img src="imgs/producto-ssangyong-2.png" class="img-fluid" alt="">
                            <p class="destacado no-space">Kit Barras Antivuelcos Ssangyong
                                <br>ACTYON
                                <br>SKU: 123456789
                            </p>
                            <h3><strong>$59.900</strong></h3>
                            <a href="ssangyong-interno.php" class="btn btn-lg btn-cotizar bloque">COTIZAR</a>
                        </div> <!-- col-3 -->
                    ...
                    <!-- FILTROS -->
                    <div class="col-md-12 mb-3 text-center">
                        <button class="btn btn-lg btn-ssangyong inline-block"><i class="fas fa-search mr-2"></i>VER MÁS PRODUCTOS</button>
                    </div>
