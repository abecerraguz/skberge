...
<section class="total fondo-negro">
    <img src="imgs/banner-marca-mmc.jpg" alt="banner-marca-mmc" class="img-fluid" />
</section>
...
<section class="total">
    <section class="container top-30 bottom-30">
        <div class="row text-center">
            <div class="col-md-12">
                <h3>ENCUENTRA TU ACCESORIO PARA TU MITSUBISHI - L200</h3>
            </div>
        </div>
                    ...
                    <div class="form-row">
                       ...
                       <!-- <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-12 mb-3 text-center">
                            <button class="btn btn-lg btn-mitsubishi inline-block"><i class="fas fa-search mr-2"></i>Filtrar</button>
                            <button class="btn btn-lg btn-mitsubishi inline-block"><i class="fas fa-search mr-2"></i>Eliminar Filtrar</button>
                        </div>
                ...
                <div class="col-md-12 top-20">
                    <div class="row text-left">
                        ...
                        <div class="col-md-3 bottom-30">
                            <img src="imgs/producto-tipo-mitsubishi.png" class="img-fluid" alt="">
                            <p class="destacado no-space">Kit Base Barras Mitsubishi
                                <br>L200
                                <br>SKU: 123456789
                            </p>
                            <h3><strong>$85.900</strong></h3>
                            <a href="mitsubishi-interno.php" class="btn btn-lg btn-cotizar-mitsubishi bloque">COTIZAR</a>
                        </div> <!-- col-3 -->
                    ...
                    <!-- FILTROS -->
                    <div class="col-md-12 mb-3 text-center">
                        <button class="btn btn-lg btn-mitsubishi inline-block"><i class="fas fa-search mr-2"></i>VER MÁS PRODUCTOS</button>
                    </div>
